  ...
  return (
    <div>
      <div className="bg-green-100 text-center py-10 shadow-2xl">
        ...
        <p className="text-2xl text-justify mt-20 pb-4 px-5 tracking-widest animated-text-right">Heyllo Alpha connects our clients with our expert members to gain much needed credible and reliable insight into technical intel on specific topic as well as market intelligence. This Alpha edge help our clients make informed strategic and investment decisions.</p>
        ...
        Heyllo Alpha recognizes the sensitivity of corporate Information that you share with our service, and we are committed to protecting your privacy. “ Information” in this Privacy Policy refers to information related to you, such as but not limited to, your name, email address, IP address, the company you work at, address of the company you work at, and your designation/role within the company. 
        </p> 
      </div>
