...
const Job = () => {
  return (
    <div className="bg-green-100 px-5 py-5 animated-text-left shadow-2xl">
      ...
      <ul className="mb-3">
        <li><FontAwesomeIcon className='mr-3' icon={faCircleExclamation}/>Send your CV to hr@heylloalpha.com. Please mention the position name in the subject line. </li>
      </ul>
      </div>
  );
};
