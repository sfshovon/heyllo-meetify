    ...
    <div className="mt-auto">
      ...
      <section className="hero min-h-screen" style={{ backgroundImage: `url("https://i.ibb.co/4N7WFd5/background2.jpg")` }}>
        ...
        <div className="hero-content text-center text-neutral-content">
          <div>
            <h1 className="-mt-20 mb-5 text-5xl font-bold animated-text-left">Heylloalpha</h1>
            <p className="text-2xl animated-text-right">We are HEYLLO.ALPHA</p>
            <br />
      ...
      <section className="bg-emerald-100">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
            <div className="mr-auto place-self-center lg:col-span-7">
                ...
                <p className={`max-w-2xl mb-6 font-normal text-gray-500 lg:mb-8 md:text-lg lg:text-xl  tracking-widest text-justify ${scrollStyle ? "animated-text-left" : "hidden"}`}>Heylloalpha connects our institutional clients to our exclusive expert network , to gain much needed insight on various industry specific subject matters .The unique interactive approach to knowledge gathering sets Heyllo Alpha apart from all the typical third party research firms, where information is never objective and mostly biased and many cases unreliable. </p>
            </div>
  
            <div className={`hidden lg:mt-0 lg:col-span-5 lg:flex ${scrollStyle ? "animated-text-right": "hidden"}`}>
                <img src="https://i.ibb.co/5nRk9Y0/logo2.png" alt="Logo"/>
            </div>                
        </div>
      </section>
          ...
          <div className="flex flex-wrap -m-4 h-auto">
            ...
            <div className={`xl:w-1/3 md:w-1/2 p-4 ${scrollStyle ? "animated-text-left": "hidden"}`}>
              <div className="border border-gray-300 p-6 rounded-lg">
                ...
                <p className="mt-3 text-lg text-justify text-gray-600 h-56">Siara's goal is to help you create various and complicated software solutions for your company. After listening to your ideas, we integrate and create unique software solutions from scratch, designed specifically for your company or organization. Siara always provides high-quality software and excellent customer service.</p>
              </div>
            </div>
            <div className={`xl:w-1/3 md:w-1/2 p-4 ${scrollStyle ? "animated-text-bottom": "hidden"}`}>
              <div className="border border-gray-300 p-6 rounded-lg">
                ...
                <p className="mt-3 text-lg text-justify text-gray-600 h-56">Siara develops disruptive web products by looking beyond conventional solutions. Our talented and committed web development team understands your requirements and uses the vibrancy of dynamic web architectures to create professional web applications.</p>
              </div>
            </div>
